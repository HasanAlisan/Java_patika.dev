...
public class Odev3ArtikYilHesaplama {
    public static void main(String[] args) {
        Scanner input=new Scanner(System.in);
        int year;
        boolean artikMi=false;
        System.out.print("Artık yıl hesaplaması. Yıl giriniz: ");
        year= input.nextInt();
        ...
        System.out.println(year+" Artık yıl mı? --> "+artikMi);
