...
public class Pratik3GelismisHesapMakinesi {
    ...
    static void mod() {
        ...
        number= scan.nextInt();
        System.out.print("Mod sayıyısını giriniz:");
        modNumber= scan.nextInt();
        System.out.println("mod:"+(number%modNumber));

    }

    static void diktorgenAlanCevre() {
        Scanner scan = new Scanner(System.in);
        int kenarKısa,kenarUzun;
        System.out.print("Uzun kenarı giriniz:");
        kenarUzun= scan.nextInt();
        System.out.print("Kısa kenarı giriniz:");
        kenarKısa= scan.nextInt();
        System.out.println("dikdörtgenin çevresi: "+(kenarKısa+kenarUzun)*2);
        System.out.println("dikdörtgenin alanı: "+kenarKısa*kenarUzun);
